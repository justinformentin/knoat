...
function AddCommentBox({
  ...
  return (
    <div className="CommentPlugin_AddCommentBox" ref={boxRef}>
      ...
      >
        <MessageSquareText className="self-center size-4" />
      </button>
    </div>
  );
}
        ...
        <PlainTextPlugin
          contentEditable={
            <ContentEditable
              ...
              placeholder={
                <div className="absolute truncate top-2 left-7 right-7 lg:left-2 lg:right-2 inline-block">
                  {placeholder}
                </div>
              }
              className={className}
  ...
  return (
    <>
      ...
      <Button
        ...
        disabled={!canSubmit}
      >
        <SendHorizonal className="self-center size-4" />
      </Button>
    </>
  );
}
      ...
      {!comment.deleted && (
        <Dialog open={open} onOpenChange={setOpen}>
          <DialogTrigger asChild>
            ...
            >
              <Trash2 className="self-center size-4" />
            </Button>
          </DialogTrigger>
          <DialogContent>
  ...
  return (
    <>
      ...
      {createPortal(
        ...
        >
          <MessagesSquare className="self-center size-4" />
        </Button>,
        document.body
      )}
      {showComments &&
