  ...
  return (
    <>
      ...
      <div className="h-full w-full overflow-auto">
        <div className="mx-auto max-w-4xl py-12 [&>h1]:text-2xl [&>h2]:text-xl [&>h3]:text-lg [&>h1]:font-semibold [&>h2]:font-semibold [&>h3]:font-semibold space-y-4">
          ...
          <ul>
            ...
            <li>
              <p>
                ...
                in this Agreement) refers to Knoat LLC, 2389 Main St Suite 100, Glastonbury, CT 06033.
              </p>
            </li>
            <li>
              <p>
            ...
            <li>
              <p>
                <strong>Website</strong> refers to Knoat, accessible from{' '}
                <a
                  href="https://knoat.com"
          ...
          <ul>
            <li>
              By email at contact@formentin.com
            </li>
          </ul>
        </div>
      </div>
