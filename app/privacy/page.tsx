    ...
    <>
      ...
      <div className="h-full w-full overflow-auto">
        <div className="mx-auto max-w-4xl py-12 [&>h1]:text-2xl [&>h2]:text-xl [&>h3]:text-lg [&>h1]:font-semibold [&>h2]:font-semibold [&>h3]:font-semibold space-y-4">
          ...
          <ul>
            ...
            <li>
              <p>
                ...
                in this Agreement) refers to Insurance Horror.
              </p>
            </li>
            <li>
              <p>
            ...
            <li>
              <p>
                <strong>Website</strong> refers to Insurance Horror, accessible
                from{' '}
                <a
                  href="https://insurancehorror.com"
                  rel="external nofollow noopener"
                  target="_blank"
                >
                  https://insurancehorror.com
                </a>
              </p>
            </li>
            <li>
          ...
          <h3 className="font-semibold text-lg">Delete Your Personal Data</h3>
          <p>
